...
public final class NNCalcController1 implements NNCalcController {
    ...
    private static void updateViewToMatchModel(NNCalcModel model,
        ...
        NaturalNumber userInput = model.bottom();
        NaturalNumber userOutput = model.top();

        view.updateBottomDisplay(userInput);
        view.updateTopDisplay(userOutput);
